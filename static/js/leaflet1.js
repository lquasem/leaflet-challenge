...
var link = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2019-09-01&endtime=" +
  "2019-09-08&maxlongitude=-69.52148437&minlongitude=-123.83789062&maxlatitude=48.74894534&minlatitude=25.16517337";
...
function createFeatures(earthquakeData) {
    ...
    function onEachFeature(feature, layer) {
        ...
        circles.push(
          ...
          "  Magnitude : " +  feature.properties.mag + "</h3>")
        );
...
function createMap(earthquakes){
    ...
    legend.onAdd = function() {
        ...
        for (var i = 0; i < grades.length; i++) {
              div.innerHTML += 
                  '<li style="background:' + chooseColor(grades[i + 1] ) + '">' +
